...
export default class GoogleMap {
	...
	init () {
		if (typeof window.gmInit !== 'undefined' && typeof window.SLEEK_GOOGLE_MAPS_API_KEY !== 'undefined') {
			...
			console.warn('Please create a window.gmInit() and set window.SLEEK_GOOGLE_MAPS_API_KEY');
		}
	}
}
